...
/**
 * @brief 卖出产品命令（Sell Product Command）；
 *        Command object for placing a sell order.
 */
public final class SellProductCommand {
    ...
    /**
     * @brief 构造卖出命令（Construct Sell Command）；
     *        Construct sell-product command.
     *
