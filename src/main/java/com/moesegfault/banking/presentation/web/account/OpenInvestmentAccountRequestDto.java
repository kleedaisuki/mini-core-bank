...
/**
 * @brief 开立投资账户请求 DTO（Open Investment Account Request DTO），对应 `POST /accounts/investment`；
 *        Open-investment-account request DTO for `POST /accounts/investment`.
 */
public record OpenInvestmentAccountRequestDto(
     ...
     */
    public OpenInvestmentAccountRequestDto {
