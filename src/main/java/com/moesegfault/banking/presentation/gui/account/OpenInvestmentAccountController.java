...
/**
 * @brief 开立投资账户控制器（Open Investment Account Controller），处理投资开户提交事件；
 *        Open-investment-account controller handling investment opening submit events.
 */
public final class OpenInvestmentAccountController implements GuiController {

    /**
     * @brief 提交事件类型（Submit Event Type）;
     *        View-event type for form submit.
     */
    public static final String EVENT_SUBMIT = "open_investment_account.submit";
     ...
     *        Page model.
     */
    private final OpenInvestmentAccountModel model;
     ...
     *        Construct open-investment-account controller.
     *
     ...
     */
    public OpenInvestmentAccountController(
            final OpenInvestmentAccountHandler applicationHandler,
            final OpenInvestmentAccountModel model,
     ...
     *        Handle submit event payload and execute investment opening use case.
     *
