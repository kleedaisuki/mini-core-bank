...
public final class OpenInvestmentAccountView
     ...
     */
    private OpenInvestmentAccountModel model;
     ...
     *        Construct open-investment-account view.
     *
     ...
     */
    public OpenInvestmentAccountView(
     ...
     */
    @Override
    public void bindModel(final OpenInvestmentAccountModel model) {
        final OpenInvestmentAccountModel normalizedModel = Objects.requireNonNull(model, "model must not be null");
        if (this.model != null) {
    ...
    public void mount() {
        ...
        formView.onSubmit(() -> eventSink.accept(new ViewEvent(
                OpenInvestmentAccountController.EVENT_SUBMIT,
    ...
    private void maybeRenderError(final String errorMessage) {
        ...
        errorDialogView.showError("open_investment_account_failed", errorMessage);
    ...
    private void maybeRenderSuccess(final OpenAccountResult result) {
        ...
        successDialogView.showSuccess(
                "open_investment_account_succeeded",
