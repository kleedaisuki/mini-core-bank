...
/**
 * @brief 买入投资产品页面模型（Buy Product Page Model）；
 *        GUI model holding buy-order form state and result feedback.
 */
public final class BuyProductModel extends AbstractGuiModel {
     ...
     *        Mark model state after successful buy command.
     *
     ...
     *        Mark model state after failed buy command.
     *
